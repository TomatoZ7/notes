...
- [深入理解 MySQL 索引底层原理](#深入理解-mysql-索引底层原理)
  - [1.Mysql 索引底层数据结构选型](#1mysql-索引底层数据结构选型)
    - [1.1 哈希表](#11-哈希表)
    - [1.2 二叉查找树(BST)](#12-二叉查找树bst)
    - [1.3 AVL 树和红黑树](#13-avl-树和红黑树)
    - [1.4 B 树](#14-b-树)
  - [2.Innodb 引擎和 Myisam 引擎的实现](#2innodb-引擎和-myisam-引擎的实现)
    - [2.1 MyISAM 引擎的底层实现（非聚集索引方式）](#21-myisam-引擎的底层实现非聚集索引方式)
    - [2.2 Innodb 引擎的底层实现（聚集索引方式）](#22-innodb-引擎的底层实现聚集索引方式)
  - [3.参考](#3参考)
...
![image](Images/mysql_index_2.jpg)
...
![image](Images/mysql_index_4.jpg)
